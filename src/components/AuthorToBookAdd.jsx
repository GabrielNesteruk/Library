...
const BookAdd = () => {
  ...
  function postAuthorToBook(authorToBook){
    return axios.post('http://localhost:8081/api/books/' + authorToBook.bookId + "/authors/" + authorToBook.authorId)
      .then((response) => {
...

        {
            ...
            <form onSubmit={submitForm}>
                <div className="booksform-input">
                  ...
                  <select style={{padding: "8px"}} id="bookId" onChange={(e) => onChange(e)}>
                ...
                <div className="booksform-input">
                  <label className="booksform-label">AUTOR</label><br/>
                  <select style={{padding: "8px"}} id="authorId" onChange={(e) => onChange(e)}>
