...
const BookAdd = () => {
  ...
  function postBook(book){
    return axios.post('http://localhost:8081/api/books', book)
      .then((response) => {
  ...
  function addCategory(bookId) {
    return axios.post('http://localhost:8081/api/books/' + bookId + '/categories/' + categoryId)
    .then((response) => {
      return response;
    })
    .catch((error) => {
    ...
    <div>
      ...
      <div className="booksform-container">
        ...
        <div className="booksform-input">
          ...
          <div className="booksform-input">
            <label className="booksform-label">Kategoria</label><br/>
